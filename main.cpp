...
public:
    int anotaciones;
    Atacante(string nombre,int anota){
        this->nombre = nombre;
        this->anotaciones = anota;
    }
    string getTipo(){return "Atacante";}
    int getAnotaciones(){return this->anotaciones;}
    void operator+=(int param){this->anotaciones += param;}
};
//**Portero**
//Constructor: inicializa los atributos de clase dados los parametros
...
public:
    int atajadas;
    Portero(string n,int a){
        this->nombre = n;
        this->atajadas = a;
    }
    string getTipo(){return "Portero";}
    int getAtajadas(){return this->atajadas;}
    void operator+=(int param){this->atajadas+=param;}
